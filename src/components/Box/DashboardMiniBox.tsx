...
function DashboardMiniBox(props: DashboardBoxProps): JSX.Element {
  ...
  return (
    ...
    className={`Dashboard-box p-4  min-h-[100px]  rounded-lg border ${theme === '#687478' || theme === '#ff6666' ? 'border-[#99a7cc]' : 'border-primary'}`}>
...
export default DashboardMiniBox
