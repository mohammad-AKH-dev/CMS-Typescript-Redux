    ...
    <div className="flex ">
      ...
      >
        ...
        ${
          !isOpen
                ...
                <Card className="bg-inherit border-none">
                  <CardHeader>
                    ...
                    <CardDescription className="flex items-center gap-x-2">
                      <span className="text-[24px] text-title font-title">
                        400
                      </span>
              ...
              <DashboardBox title="Products">
                ...
                <ul className="Dashboard-box__list mt-6 flex flex-col gap-y-3 sm:gap-y-12">
                  <li className="Dashboard-box__item flex flex-wrap sm:flex-nowrap gap-y-4 justify-between items-center">
                    ...
                    <div>
                      <span className="price text-title text-[13px]">
                        $ 1,099.00
                      </span>
                    </div>
                  </li>
            ...
            <section
              ...
              className={`orders-status-section mt-8 border rounded-lg ${
        ...
        flex items-center justify-between`}
              >
                <h4 className="orders-status__title text-title font-title text-[20px]">
                  Orders Status
                </h4>
                <div className="orders-status__buttons flex items-center flex-wrap sm:flex-nowrap gap-y-6 sm:gap-y-0 gap-x-4">
                  ...
                  <button
                    type="button"
                    className="px-2 py-3 bg-selected rounded-lg text-title text-[12px]"
                  >
                    Create order
                  </button>
                </div>
