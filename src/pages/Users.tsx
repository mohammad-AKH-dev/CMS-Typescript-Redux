        ...
        <div className="main-content">
          <section className="users-section mt-12 pr-16 sm:pr-0">
            ...
            <div className="users-box grid grid-cols-1 gap-y-4 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 users-boxes__wrapper gap-x-8">
              <UsersBox
                icon=<FaUserGroup className="text-[#CB3CFF]" />
                title="Total Users"
                subtitle={250}
              ...
              <UsersBox
                ...
                title="New Users"
                subtitle={15}
                background="rgba(227,176,77,0.2)"
              />
              <UsersBox
                icon=<FaHeart className="text-[#05C168]" />
                title="Top Users"
                subtitle={200}
                background="rgba(5,193,104,0.2)"
              />
              <UsersBox
                icon=<CgMoreO className="text-[#086CD9]" />
                title="Other Users"
                subtitle={35}
                background="rgba(8,108,217,0.2)"
              />
            </div>
            {/* users table */}
            <section
              ...
              className={`users-section mt-8 border rounded-lg ${
